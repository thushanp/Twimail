...
<head>
    ...
    <title>Evan's Landing Page</title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-2">
                    ...
                    <br>
                    <form enctype="multipart/form-data" action="uploadevan.php" method="POST">
    ...
    <section id="call" class="content-section-b">
        <div class="container">
            ...
            <div class="col-lg-5 offset-lg-2">
                  ...
                  <form method="POST" action="/evanvoice.php">
<!--                   <form> -->
                  ...
                  <script>
                    ...
                    <?php
                    unlink('storageevan.html');
                    $fh = fopen('storageevan.html', 'w');
                    fwrite($fh, $var_value);
                    fclose($fh);
