...
<head>
    ...
    <title>Brad's Landing Page</title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-2">
                    ...
                    <br>
                    <form enctype="multipart/form-data" action="uploadbrad.php" method="POST">
    ...
    <section id="call" class="content-section-b">
        <div class="container">
            ...
            <div class="col-lg-5 offset-lg-2">
                  ...
                  <form method="POST" action="/bradvoice.php">
<!--                   <form> -->
                  ...
                  <script>
                    ...
                    <?php
                    unlink('storagebrad.html');
                    $fh = fopen('storagebrad.html', 'w');
                    fwrite($fh, $var_value);
                    fclose($fh);
            ...
            <div class="col-lg-5">
                ...
                <div class="clearfix"></div>
                    ...
                    6. If you reach an answering machine, press "9#" after the beep and your voice message will play. You can then freely hang up and make another call if you like or wait until it ends. If you reach a human, talk to them normally and then, once you're finished speaking, press "9#" and then hangup. </p>
                </div>
            </div>
