<?php
    ...
    foreach ($participants as $participant)
    {
        ...
        $call = $client->account->calls->create(
            ...
            array("url" => ($participant == '+14054001401') ? "http://ec2-13-59-179-35.us-east-2.compute.amazonaws.com/twimlgatherbrian.php" : "http://ec2-13-59-179-35.us-east-2.compute.amazonaws.com/standardresponsebrian.php",
